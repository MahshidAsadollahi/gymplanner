      ...
      <div className="flex flex-col gap-6 lg:gap-12 text-center w-full mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between lg:gap-10">
          <div className="lg:w-1/2 text-left">
            ...
            <Link href="/start">
              <Button size="lg" className="start-now-button w-60 mt-16 py-7 text-xl animate__animated animate__infinite animate__pulse rounded-full shadow-lg mx-auto lg:ml-0 ml-4">
                Start Now
              </Button>
